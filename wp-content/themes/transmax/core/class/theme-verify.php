    ...
    class WGL_Theme_Verify
    {
        ...
        */
        ...
        private function hooks(){
            ...
            add_action( 'admin_notices', array( $this, 'wgl_extensions_requirements' ), 90);
            ...
            <div class="notice notice-error is-dismissible">
                <p>
                    <?php echo wp_get_theme()->get('Name');
                        echo sprintf( esc_html__( ' Theme is not activated! Please activate your copy of the %s Theme.', 'transmax'), wp_get_theme()->get('Name') );
                        ?>
                </p>
                <p>
                    <strong class="activate_error"><?php esc_html_e( 'Please activate the theme!', 'transmax' ); ?></strong> -
                    <a href="<?php echo esc_url(( $page_purchase )); ?>">
                        <?php esc_html_e( 'Activate Now','transmax' ); ?>
                    </a>
                </p>
            </div>
        ...
        public function wgl_extensions_requirements(){
            ...
            <div class="notice notice-error is-dismissible">
                <p>
                    <?php
                        echo esc_html__( 'WGL Extensions plugin is not activated! Please install and activate it first.', 'transmax');
                    ?>
                </p>
            </div>
            ...
            <div class="notice notice-warning is-dismissible">
                <p class="support-until_text">
                    <?php
                        ...
                        if($now > $until_date){
                            echo sprintf( wp_kses( __( '<strong>Your support period expired. <a href="%s">You can prolong support</a> services as you need.</strong>', 'transmax' ), $allowed_html), esc_url($item_url));
                        }elseif($now < $until_date && $interval->days < 30){
                            echo sprintf( wp_kses( __( '<strong>Your support period will be expired after %d days. <a href="%s">You can prolong support</a> services as you need.</strong>', 'transmax' ), $allowed_html), $interval->days, esc_url($item_url));
                        }
                ...
                <p>
                    ...
                    ?>
                    <a href="<?php echo esc_url($remind_url); ?>" class="button button-primary"><?php echo esc_html__( 'Remind me later', 'transmax' ); ?></a>&nbsp;
                    <a href="<?php echo esc_url($delete_url); ?>" class="button button-primary"><?php echo esc_html__( 'Hide and disable further reminders', 'transmax' ); ?></a>
                </p>
            </div>
