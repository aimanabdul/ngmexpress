...
class WGL_Header_Logo extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Logo', 'transmax-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'use_custom_logo',
            [
                'label' => esc_html__('Use Custom Logo?', 'transmax-core'),
        ...
        $this->add_control(
            'custom_logo',
            [
                'label' => esc_html__('Custom Logo', 'transmax-core'),
        ...
        $this->add_control(
            'enable_logo_height',
            [
                'label' => esc_html__('Enable Logo Height?', 'transmax-core'),
                'type' => Controls_Manager::SWITCHER,
                'condition' => ['use_custom_logo!' => ''],
            ]
        );
        ...
        $this->add_control(
            'logo_height',
            [
                'label' => esc_html__('Logo Height', 'transmax-core'),
    ...
    public function render()
    {
        ...
        new \Transmax_Get_Logo('bottom', false, $logo, $custom_size);
    }
}
