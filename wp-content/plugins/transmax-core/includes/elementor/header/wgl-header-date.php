...
class WGL_Header_Date extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('WGL Current Date', 'transmax-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Date Settings', 'transmax-core'),
            ]
        );
        ...
        $this->add_control(
            'date_format_select',
            [
                'label' => esc_html__('Date Format', 'transmax-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'default' => esc_html__('Default', 'transmax-core'),
                    'wordpress_format' => esc_html__('Wordpress Format', 'transmax-core'),
        ...
        $this->add_control(
            'date_format_custom',
            [
                'label' => esc_html__('Custom Date Format', 'transmax-core'),
                ...
                'description' => __( 'Set your date format, about this, please refer to the ', 'transmax-core') . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://wordpress.org/support/article/formatting-date-and-time/', __( 'Wordpress.org', 'transmax-core') ),
            ]
        );
        ...
        $this->add_control(
            'time_zone',
            [
                'label' => esc_html__('Time Zone', 'transmax-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'UTC' => esc_html__('Default', 'transmax-core'),
	    ...
	    $this->start_controls_section(
		    'section_date_style',
		    [
			    'label' => esc_html__('Date Style', 'transmax-core'),
		    ]
	    );
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-header-date > span:first-child' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'month_year_color',
            [
                'label' => esc_html__('Month and Year Colors', 'transmax-core'),
                'type' => Controls_Manager::COLOR,
                'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-header-date > span:last-child' => 'color: {{VALUE}}',
                ],
            ]
        );
