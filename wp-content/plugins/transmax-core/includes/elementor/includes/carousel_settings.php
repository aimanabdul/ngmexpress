    ...
    class WGL_Carousel_Settings
    {
        ...
        public static function add_controls($self, $extra_fields = [])
        {
            ...
            $self->add_control(
                'use_carousel',
                [
                    'label' => esc_html__('Use Carousel', 'transmax-core'),
        ...
        public static function add_general_controls($self, $extra_fields = [])
        {
            $self->add_responsive_control(
                'slider_container_padding',
                [
                    'label' => esc_html__('Container Padding', 'transmax-core'),
            ...
            $self->add_control(
                ...
                [
                    ...
                    'options' => [
                        'default' => esc_html__('Horizontal Default', 'transmax-core'),
                        'horizontal' => esc_html__('Horizontal 3D', 'transmax-core'),
                        'vertical' => esc_html__('Vertical 3D', 'transmax-core'),
                    ],
            ...
            $self->add_responsive_control(
                'animation_vertical_height',
                [
                    'label' => esc_html__('Carousel Height', 'transmax-core'),
            ...
            $self->add_control(
                'animation_triggered_by_mouse',
                [
                    'label' => esc_html__('Triggered by Mouse Wheel', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'autoplay',
                [
                    'label' => esc_html__('Autoplay', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'autoplay_speed',
                [
                    'label' => esc_html__('Autoplay Speed', 'transmax-core'),
            ...
            $self->add_control(
                'slider_infinite',
                [
                    'label' => esc_html__('Infinite Loop', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'slide_per_single',
                [
                    'label' => esc_html__('Slide per single item', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'fade_animation',
                [
                    'label' => esc_html__('Fade Animation', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'condition' => [
                        'posts_per_row' => '1',
                        'animation_style' => 'default',
            ...
            $self->add_control(
                'center_mode',
                [
                    'label' => esc_html__('Center Mode', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
        ...
        public static function add_pagination_controls($self, $extra_fields = [])
        {
            $self->add_control(
                'use_pagination',
                [
                    'label' => esc_html__('Add Pagination Controls', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'pagination_custom_colors',
                [
                    'label' => esc_html__('Customize Colors', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
        ...
        public static function add_navigation_controls($self, $extra_fields = [])
        {
            $self->add_control(
                'use_navigation',
                [
                    'label' => esc_html__('Add Navigation Controls', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'navigation_position',
                [
                    'label' => esc_html__('Positioning', 'transmax-core'),
                    ...
                    'options' => (
                        $extra_fields['navigation_position']['options'] ?? [
                            '' => esc_html__('Opposite sides', 'transmax-core'),
                            'nearby' => esc_html__('Nearby', 'transmax-core'),
                        ]
                    ),
                    'default' => '',
                ]
                ...
                [
                    ...
                    'options' => (
                        $extra_fields['navigation_position']['options'] ?? [
                            ...
                            'under_each_other' => esc_html__('Under each other', 'transmax-core'),
                        ]
                    ),
                    'default' => 'under_each_other',
                ]
            );
            ...
            $self->add_responsive_control(
                'navigation_distance',
                [
                    'label' => esc_html__('Buttons Distance', 'transmax-core'),
                    'type' => Controls_Manager::SLIDER,
                    'condition' => [
                        'use_navigation' => 'yes',
                        'navigation_position' => 'nearby'
            ...
            $self->add_responsive_control(
                ...
                [
                    'label' => esc_html__('Vertical Offset', 'transmax-core'),
                    'type' => Controls_Manager::SLIDER,
                    'condition' => ['use_navigation' => 'yes']
                        + ($extra_fields['use_navigation']['condition'] ?? [])
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .elementor-swiper-button,
                         ...
                         '{{WRAPPER}} .navigation-posiiton-nearby.navigation-view-under_each_other .elementor-swiper-button.elementor-swiper-button-prev' => 'top: calc({{SIZE}}{{UNIT}} + var(--wgl-swiper-button-diameter) / 2 + var(--wgl-swiper-buttons-distance));',
            ...
            $self->add_responsive_control(
                ...
                [
                    'label' => esc_html__('Horizontal Offset', 'transmax-core'),
                    'type' => Controls_Manager::SLIDER,
                    'condition' => ['use_navigation' => 'yes']
                        + ($extra_fields['use_navigation']['condition'] ?? [])
                    ...
                    'selectors' => [
                        ...
                        '{{WRAPPER}} .navigation-posiiton-nearby .elementor-swiper-button-next,
                         {{WRAPPER}} .navigation-posiiton-nearby .motion-next' => 'left: calc({{SIZE}}{{UNIT}} + 50% + var(--wgl-swiper-button-diameter) / 2 - var(--wgl-swiper-buttons-distance));',
                         ...
                         '{{WRAPPER}} .navigation-posiiton-nearby.navigation-view-under_each_other .elementor-swiper-button.elementor-swiper-button-prev' => 'left: calc({{SIZE}}{{UNIT}} + 50% - var(--wgl-swiper-button-diameter) - var(--wgl-swiper-buttons-distance) / 2);',
                         '{{WRAPPER}} .navigation-posiiton-nearby.navigation-view-under_each_other .elementor-swiper-button.elementor-swiper-button-next' => 'left: calc({{SIZE}}{{UNIT}} + 50% - var(--wgl-swiper-button-diameter) - var(--wgl-swiper-buttons-distance) / 2);',
                    ],
                ]
            );
            ...
            $self->add_group_control(
                ...
                [
                    ...
                    'fields_options' => [
                        ...
                        'color' => ['label' => esc_html__('Border Color', 'transmax-core')]
                    ],
            ...
            $self->add_group_control(
                ...
                [
                    ...
                    'fields_options' => [
                        'width' => ['label' => esc_html__('Border Width', 'transmax-core')],
                        'color' => ['label' => esc_html__('Border Color', 'transmax-core')],
                    ],
        ...
        public static function add_responsive_controls($self, $extra_fields = [])
        {
            ...
            $self->add_control(
                'customize_responsive',
                [
                    'label' => esc_html__('Customize Responsive', 'transmax-core'),
                    'type' => Controls_Manager::SWITCHER,
            ...
            $self->add_control(
                'heading_desktop',
                [
                    'label' => esc_html__('Desktop Settings', 'transmax-core'),
            ...
            $self->add_control(
                'desktop_breakpoint',
                [
                    'label' => esc_html__('Screen Breakpoint', 'transmax-core'),
                    'type' => Controls_Manager::NUMBER,
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
                        + ($extra_fields['desktop_breakpoint']['condition'] ?? []),
	                'description' => esc_html__('Equal or greater width screens are targeted.', 'transmax-core'),
            ...
            $self->add_control(
                'desktop_slides',
                [
                    'label' => ($extra_fields['desktop_slides']['label'] ?? esc_html__('Slides to show', 'transmax-core')),
                    'type' => Controls_Manager::NUMBER,
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'heading_tablet',
                [
                    'label' => esc_html__('Tablet Settings', 'transmax-core'),
                    'type' => Controls_Manager::HEADING,
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'tablet_slides',
                [
                    'label' => ($extra_fields['tablet_slides']['label'] ?? esc_html__('Slides to show', 'transmax-core')),
                    'type' => Controls_Manager::NUMBER,
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'heading_mobile',
                [
                    'label' => esc_html__('Mobile Settings', 'transmax-core'),
                    'type' => Controls_Manager::HEADING,
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
            ...
            $self->add_control(
                'mobile_slides',
                [
                    'label' => ($extra_fields['mobile_slides']['label'] ?? esc_html__('Slides to show', 'transmax-core')),
                    'type' => Controls_Manager::NUMBER,
                    'condition' => ['customize_responsive' => 'yes']
                        + ($extra_fields['customize_responsive']['condition'] ?? [])
        ...
        public static function init($atts, $items = [], $templates = false)
        {
            ...
            if ('default' === $animation_style) {
                ...
                $navigation_position_class .= $use_navigation && $navigation_view ? ' navigation-view-under_each_other' : '';
