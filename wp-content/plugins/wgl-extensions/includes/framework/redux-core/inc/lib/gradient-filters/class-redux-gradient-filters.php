	...
	class Redux_Gradient_Filters {
		...
		public static function render_select( array $data ): string {
			...
			if ( $field['gradient-type'] ) {
				...
				$output .= '<strong>' . esc_html__( 'Gradient Type ', 'wgl-extensions' ) . '</strong>&nbsp;';
				$output .= '<select ';
				$output .= 'class="redux-gradient-select select2-container"';
				$output .= 'data-placeholder="' . esc_attr__( 'Type', 'wgl-extensions' ) . '" ' . $select2_data . ' ';
				...
				$arr = array(
					esc_html__( 'linear', 'wgl-extensions' ),
					esc_html__( 'radial', 'wgl-extensions' ),
				);
		...
		public static function render_sliders( array $data ): string {
			...
			if ( $field['gradient-reach'] ) {
				...
				$output .= '<label>' . esc_html__( 'From Reach ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $value['gradient-reach']['from'] ) . '%</strong></label>';
				$output .= '<div ';
				...
				$output .= 'data-label="' . esc_attr__( 'From Reach', 'wgl-extensions' ) . '"';
				...
				$output .= '<label>' . esc_html__( 'To Reach', 'wgl-extensions' ) . ':  <strong>' . esc_html( $value['gradient-reach']['to'] ) . '%</strong></label>';
				$output .= '<div ';
				...
				$output .= 'data-step="1"';
				$output .= 'data-rtl="' . esc_attr( is_rtl() ) . '"';
				$output .= 'data-label="' . esc_attr__( 'To Reach', 'wgl-extensions' ) . '"';
			...
			if ( $field['gradient-angle'] ) {
				...
				$output .= '<label>' . esc_html__( 'Gradient Angle', 'wgl-extensions' ) . ':  <strong>' . $value['gradient-angle'] . '&deg;</strong></label>';
				$output .= '<div ';
				...
				$output .= 'data-step="1"';
				$output .= 'data-rtl="' . esc_attr( is_rtl() ) . '"';
				$output .= 'data-label="' . esc_attr__( 'Gradient Angle', 'wgl-extensions' ) . '"';
