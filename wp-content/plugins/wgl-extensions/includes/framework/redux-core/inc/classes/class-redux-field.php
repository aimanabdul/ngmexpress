...
if ( ! class_exists( 'Redux_Field', false ) ) {
	...
	abstract class Redux_Field {
		...
		public static function make_base_descriptor(): Redux_Descriptor {
			...
			$d->add_field( 'id', __( 'Field ID', 'wgl-extensions' ), RDT::TEXT )->set_order( 0 )->set_required();
			$d->add_field( 'title', __( 'Title', 'wgl-extensions' ), RDT::TEXT )->set_order( 1 );
			$d->add_field( 'subtitle', __( 'Subtitle', 'wgl-extensions' ), RDT::TEXT )->set_order( 2 );
			$d->add_field( 'desc', __( 'Description', 'wgl-extensions' ), RDT::TEXT )->set_order( 3 );
			$d->add_field( 'class', __( 'Class', 'wgl-extensions' ), RDT::TEXT )->set_order( 3 );
			$d->add_field( 'compiler', __( 'Compiler', 'wgl-extensions' ), RDT::BOOL, '', false )->set_order( 60 );
			$d->add_field( 'default', __( 'Default', 'wgl-extensions' ), RDT::OPTIONS, '', false )->set_order( 60 );
			$d->add_field( 'disabled', __( 'Disabled', 'wgl-extensions' ), RDT::BOOL, '', false )->set_order( 60 );
			$d->add_field( 'hint', __( 'Hint', 'wgl-extensions' ), RDT::OPTIONS, '', false )->set_order( 60 );
			$d->add_field( 'hint', __( 'Permissions', 'wgl-extensions' ), RDT::OPTIONS, '', false )->set_order( 60 );
			$d->add_field( 'required', __( 'Required', 'wgl-extensions' ), RDT::BOOL, '', false )->set_order( 60 );
