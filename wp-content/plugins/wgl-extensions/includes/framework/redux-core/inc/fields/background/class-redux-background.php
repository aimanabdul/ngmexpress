	...
	class Redux_Background extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $this->field['background-repeat'] ) {
				$array = array(
					'no-repeat' => esc_html__( 'No Repeat', 'wgl-extensions' ),
					'repeat'    => esc_html__( 'Repeat All', 'wgl-extensions' ),
					'repeat-x'  => esc_html__( 'Repeat Horizontally', 'wgl-extensions' ),
					'repeat-y'  => esc_html__( 'Repeat Vertically', 'wgl-extensions' ),
					'inherit'   => esc_html__( 'Inherit', 'wgl-extensions' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-repeat-select" data-placeholder="' . esc_html__( 'Background Repeat', 'wgl-extensions' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-repeat]" class="redux-select-item redux-background-input redux-background-repeat ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-clip'] ) {
				$array = array(
					'inherit'     => esc_html__( 'Inherit', 'wgl-extensions' ),
					'border-box'  => esc_html__( 'Border Box', 'wgl-extensions' ),
					'content-box' => esc_html__( 'Content Box', 'wgl-extensions' ),
					'padding-box' => esc_html__( 'Padding Box', 'wgl-extensions' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-clip-select" data-placeholder="' . esc_html__( 'Background Clip', 'wgl-extensions' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-clip]" class="redux-select-item redux-background-input redux-background-clip ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-origin'] ) {
				...
				echo '<select id="' . esc_attr( $this->field['id'] ) . '-origin-select" data-placeholder="' . esc_html__( 'Background Origin', 'wgl-extensions' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-origin]" class="redux-select-item redux-background-input redux-background-origin ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-size'] ) {
				$array = array(
					'inherit' => esc_html__( 'Inherit', 'wgl-extensions' ),
					'cover'   => esc_html__( 'Cover', 'wgl-extensions' ),
					'contain' => esc_html__( 'Contain', 'wgl-extensions' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-size-select" data-placeholder="' . esc_html__( 'Background Size', 'wgl-extensions' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-size]" class="redux-select-item redux-background-input redux-background-size ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-attachment'] ) {
				$array = array(
					'fixed'   => esc_html__( 'Fixed', 'wgl-extensions' ),
					'scroll'  => esc_html__( 'Scroll', 'wgl-extensions' ),
					'inherit' => esc_html__( 'Inherit', 'wgl-extensions' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-attachment-select" data-placeholder="' . esc_html__( 'Background Attachment', 'wgl-extensions' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-attachment]" class="redux-select-item redux-background-input redux-background-attachment ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( true === $this->field['background-position'] ) {
				$array = array(
					'left top'      => esc_html__( 'Left Top', 'wgl-extensions' ),
					'left center'   => esc_html__( 'Left center', 'wgl-extensions' ),
					'left bottom'   => esc_html__( 'Left Bottom', 'wgl-extensions' ),
					'center top'    => esc_html__( 'Center Top', 'wgl-extensions' ),
					'center center' => esc_html__( 'Center Center', 'wgl-extensions' ),
					'center bottom' => esc_html__( 'Center Bottom', 'wgl-extensions' ),
					'right top'     => esc_html__( 'Right Top', 'wgl-extensions' ),
					'right center'  => esc_html__( 'Right center', 'wgl-extensions' ),
					'right bottom'  => esc_html__( 'Right Bottom', 'wgl-extensions' ),
				);

				echo '<select id="' . esc_attr( $this->field['id'] ) . '-position-select" data-placeholder="' . esc_html__( 'Background Position', 'wgl-extensions' ) . '" name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '[background-position]" class="redux-select-item redux-background-input redux-background-position ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $select2_data ) . '>';
				echo '<option></option>';
			...
			if ( $this->field['background-image'] ) {
				...
				$placeholder = $this->field['placeholder'] ?? esc_html__( 'No media selected', 'wgl-extensions' );
				...
				echo '<span class="button redux-background-upload" id="' . esc_attr( $this->field['id'] ) . '-media">' . esc_html__( 'Upload', 'wgl-extensions' ) . '</span>';
				...
				echo '<span class="button removeCSS redux-remove-background' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $this->field['id'] ) . '" rel="' . esc_attr( $this->field['id'] ) . '">' . esc_html__( 'Remove', 'wgl-extensions' ) . '</span>';
