		...
		public function render() {
			...
			foreach ( $shadow_arr as $shadow_type ) {
				if ( $this->field[ $shadow_type . '-shadow' ] ) {
					...
					echo esc_html( ucfirst( $shadow_type ) ) . ' ' . esc_html__( 'Shadow', 'wgl-extensions' );
					echo '</label>';
					echo '</li>';
					echo '<li>';
					...
					echo '<label>' . esc_html__( 'Horizontal Length ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['horizontal'] ) . 'px</strong></label>';
					echo '<div
                            ...
                            data-label="' . esc_attr__( 'Horizontal Length', 'wgl-extensions' ) . '"
					...
					echo '<label>' . esc_html__( 'Vertical Length ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['vertical'] ) . 'px</strong></label>';
					echo '<div
                                ...
                                data-step="1"
                                data-rtl="' . esc_attr( is_rtl() ) . '"
                                data-label="' . esc_attr__( 'Vertical Length', 'wgl-extensions' ) . '"
					...
					echo '<label>' . esc_html__( 'Blur Radius ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['blur'] ) . 'px</strong></label>';
					echo '<div
                                ...
                                data-step="1"
                                data-rtl="' . esc_attr( is_rtl() ) . '"
                                data-label="' . esc_attr__( 'Blur Radius', 'wgl-extensions' ) . '"
					...
					echo '<label>' . esc_html__( 'Spread ', 'wgl-extensions' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['spread'] ) . 'px</strong></label>';
					echo '<div
                                ...
                                data-step="1"
                                data-rtl="' . esc_attr( is_rtl() ) . '"
                                data-label="' . esc_attr__( 'Spread', 'wgl-extensions' ) . '"
