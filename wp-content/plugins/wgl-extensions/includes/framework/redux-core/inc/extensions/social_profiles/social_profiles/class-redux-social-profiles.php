...
if ( ! class_exists( 'Redux_Social_Profiles' ) ) {
	...
	class Redux_Social_Profiles extends Redux_Field {
		...
		public function render() {
			...
			$def_msg = sprintf( esc_html__( 'Go to the %1$s page to add the Redux Social Widget to any active widget area.', 'wgl-extensions' ), sprintf( '<a href="%s">' . esc_html__( 'Widgets', 'wgl-extensions' ) . '</a> ', admin_url( 'widgets.php' ) ) );
			...
			foreach ( $this->defaults as $key => $social_provider_default ) {
				...
				$label = ( $social_provider_option && array_key_exists( 'label', $social_provider_option ) && $social_provider_option['label'] ) ? $social_provider_option['label'] : __( 'Link URL', 'wgl-extensions' );
				...
				esc_html_e( 'Enabled', 'wgl-extensions' );
				echo '</div>';
				...
				$reset_text = __( 'Reset', 'wgl-extensions' );
				...
				if ( $color_pickers ) {
					...
					$label = apply_filters( 'redux/extensions/social_profiles/' . $this->opt_name . '/color_picker/text', esc_html__( 'Color', 'wgl-extensions' ) );
					...
					// phpcs:ignore WordPress.NamingConventions.ValidHookName
					$label = apply_filters( 'redux/extensions/social_profiles/' . $this->opt_name . '/color_picker/color_hover', esc_html__( 'Color Hover', 'wgl-extensions' ) );
					...
					// phpcs:ignore WordPress.NamingConventions.ValidHookName
					$label = apply_filters( 'redux/extensions/social_profiles/' . $this->opt_name . '/color_picker/background', esc_html__( 'Background', 'wgl-extensions' ) );
					...
					// phpcs:ignore WordPress.NamingConventions.ValidHookName
					$label = apply_filters( 'redux/extensions/social_profiles/' . $this->opt_name . '/color_picker/background_hover', esc_html__( 'Background Hover', 'wgl-extensions' ) );
