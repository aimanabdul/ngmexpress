                ...
                foreach ( $sortlists as $group => $sortlist ) {
                    ...
                    <div id="wgl_modal_builder_items" style="display:none;">
                        ...
                        echo '<div class="wgl_header_row-btn">';
                            ...
                            echo '<div class="wgl_header_row-disabled"><a href="#" title="'.apply_filters("wgl-disabled-row-text", __( 'Disabled row', 'wgl-extensions' )).'"><i class="fa fa-desktop"></i></a>';
                            ...
                            echo '<div class="wgl_header_row-opt" data-section-opt="'.$row_opt_id.'"><a href="#" title="'.apply_filters("wgl-edit-row-text", __( 'Edit this row', 'wgl-extensions' )).'"><i class="fas fa-pen fa"></i></a></div>';
                        echo '</div>';
                    }
                    ...
                    if($index != 0){
                        ...
                        */
                        ...
                        echo '<span class="edit_column" data-opt-col-id="'.esc_attr($column_opt_id).'"><a href="#" title="'.apply_filters("wgl-edit-column-text", __( 'Edit this column', 'wgl-extensions' )).'"><i class="fas fa fa-pen" aria-hidden="true"></i></a></span>';

                        echo '<span class="add_item"><a href="#" title="'.apply_filters("wgl-add-item", __( 'Add Item', 'wgl-extensions' )).'"><i class="fas fa-plus" aria-hidden="true"></i></a></span>';
                    }
