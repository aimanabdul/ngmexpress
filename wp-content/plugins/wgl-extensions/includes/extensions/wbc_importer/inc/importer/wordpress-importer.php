...
<?php
        ...
        function fetch_remote_file($url, $post)
        {
            ...
            //$remote_response = new WP_Error( 'http_request_failed', __('cURL error 28: Connection timeout', 'wgl-extensions'));

            if (is_wp_error($remote_response)) {
                
                if(isset($remote_response->errors['http_request_failed']) && strpos($remote_response->errors['http_request_failed'][0], 'cURL error 28')){
