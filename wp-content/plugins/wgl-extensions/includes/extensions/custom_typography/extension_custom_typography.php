...
if( !class_exists( 'ReduxFramework_extension_custom_typography' ) ) {
    /**
     * Main ReduxFramework custom_typography extension class
     *
     * @since       3.1.6
     */

    class ReduxFramework_extension_custom_typography {

        // Set the version number of your extension here
        public static $version       = '1.0.0';
        // Set the name of your extension here
        public $ext_name             = 'Custom Typography';
        ...
        */
        ...
        public function __construct( $parent ) {
            ...
            $this->field_name = 'custom_typography';
