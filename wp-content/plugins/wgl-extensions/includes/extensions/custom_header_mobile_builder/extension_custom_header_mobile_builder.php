...
if( !class_exists( 'ReduxFramework_extension_custom_header_mobile_builder' ) ) {
    /**
     * Main ReduxFramework custom_header_mobile_builder extension class
     *
     * @since       3.1.6
     */

    class ReduxFramework_extension_custom_header_mobile_builder {

        // Set the version number of your extension here
        public static $version       = '1.0.0';
        // Set the name of your extension here
        public $ext_name             = 'Header Mobile Builder';
        ...
        */
        ...
        public function __construct( $parent ) {
            ...
            $this->field_name = 'custom_header_mobile_builder';
